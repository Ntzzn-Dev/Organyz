...
### version 7.5  
- Correção ao exportar banco de dados, onde tasks e históricos de contadores não eram importados.
- Alteração do botão de criar novo repositório na pagina atual.  
